...
date: 2023-04-029T14:41:42+08:00
cover:
    image: 
    alt: ''
    caption: ''
...
2. 安裝完成後打開 Raycast，這時會跳出 Raycast Setting 畫面， 這裡比較需要注意的是，快捷鍵設定（Raycast Hotkey)，Raycast 預設是 option + 空白鍵，因為這個快捷鍵對你之後叫出 Raycast 方便程度有很大的影響，我自己是直接使用預設，剛好沒有跟我其他快捷鍵打架。
...
#使用方式 1. Figma File Search - 加速設計師找檔案的工作效率
...
#使用方式 2. Google Search - 懶得用滑鼠點來點去時很好用
